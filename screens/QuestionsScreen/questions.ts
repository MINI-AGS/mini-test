...
export const questions: Question[] = [
  ...
  {
    id: "questionL3b",
    text: "¿Actulmente cree usted esto?",
    options: ["si", "no", "si_extraños"],
    section: "sectionL11",
  },
  {
    id: "questionL4a",
    text: "¿Alguna vez ha creído que le envían mensajes especilaes a través de la radio, el televisor o el periódico, o que una persona que no conocía personalmente se interesaba particularmente por usted?",
    options: ["si", "no", "si_extraños"],
    section: "sectionL12",
  },
  {
